  ...
  useEffect(() => {
    ...
    return ( 
        <div className='w-full mt-[150px] lg:mt-[300px]' id='works'>
          <motion.h1 className='text-black font-bold monument text-5xl lg:text-8xl uppercase w-[90%] lg:w-[80%] my-0 mx-auto' ref={ref} animate={animation}>our <br /> selected <br />works </motion.h1>
          <div className='w-[90%] lg:w-[80%] lg:h-[1300px] my-[50px] mx-auto flex flex-col lg:flex-row'>
            ...
            <div className="w-full lg:w-[33.3%] lg:h-full flex flex-row-reverse lg:items-start lg:justify-evenly lg:flex-col">
              <motion.h1 className='w-full none lg:block text-black font-bold monument text-xl lg:text-7xl uppercase' ref={refTwo} animate={animationTwo}>see in <br /> black <br /> and <br /> white </motion.h1>
